...
export default class Step extends Component {
	...
	render() {
		return (
			<div>
				<h1>Coons Patch</h1>
				<p>The surface you see here might look very complex. It can take the shop of a simple plane or a self-intersecting form that would be very difficult to draw by hand, let alone fabricate in physical form.</p>
